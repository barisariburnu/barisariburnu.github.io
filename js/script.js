...
------------------------------------------------------*/
    ...
    // main directions
      map = new GMaps({
        el: '#map', lat: 41.042102, lng: 29.006515, zoom: 13, zoomControl : true, 
        zoomControlOpt: { style : 'SMALL', position: 'TOP_LEFT' }, panControl : false, scrollwheel: false
      });
    // add address markers
    map.addMarker({ lat: 41.042102, lng: 29.006515, title: 'Barış Arıburnu',
      infoWindow: { content: '<p>@barisariburnu <br/>You will never walk alone.. <br/>#Besiktas, #Istanbul, #Turkey</p>' } });
