...
export default function HomePage() {
  ...
  const codeLines = [
    ...
    { code: "    name: 'Baris Ariburnu',", type: "array-item" },
    { code: "    role: 'Senior Software Developer',", type: "array-item" },
    { code: "    bio: 'Building innovative digital solutions'", type: "array-item", },
    { code: "  };", type: "array-end" },
    { code: "", type: "blank" },
      ...
      <div className={styles.container}>
        ...
        <div className={styles.infoSection}>
          <h1 className={styles.developerName}>
            Barış <span className={styles.accentText}>Arıburnu</span>
          </h1>

          <div className={styles.developerRole}>Senior Software Developer</div>

          <p className={styles.bio}>
            I build innovative digital solutions with modern technologies.
            Specialized in GIS, full-stack development, and creating efficient
